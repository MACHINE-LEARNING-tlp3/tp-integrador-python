...
function Home() {
  ...
  const validarCampos = () => {
    for (const [clave, valor] of Object.entries(formData)) {
      if (valor === "" || isNaN(parseFloat(valor))) {
        toast.error(`El campo "${clave.replace(/_/g, " ")}" debe ser numérico.`, { duration: 5000 });
        return false;
      }
    }
    return true;
  ...
  const handleForm = async (e) => {
    ...
    const dataNumerica = Object.fromEntries(
      Object.entries(formData).map(([clave, valor]) => [clave, parseFloat(valor)])
    );

    const promise = predictionAPi(dataNumerica);

    toast.promise(promise, {
      loading: "Calculando riesgo...",
      success: (res) => `Diagnóstico: ${res.diagnostico}. 
      Probabilidad: ${res.probabilidad}%`,
      error: "Ocurrió un error al predecir.",
    }, {
    ...
    try {
      ...
      toast.error("Ocurrio un error al predecir.");
    }
    finally {
      setIsLoading(false);
    }
      ...
      <main className="bg-[#F8F1F3] min-h-screen pt-20 pb-12">
        ...
        <section className="px-6 py-12 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="w-full lg:w-1/2 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-[#F8E8EC] rounded-lg">
                    <p className="text-gray-800 flex items-start gap-3">
                      ...
                      <span>El cáncer de mama representa el 17% de todos los cánceres en mujeres.</span>
                    </p>
                  </div>
                  <div className="p-4 bg-[#F8E8EC] rounded-lg">
                    <p className="text-gray-800 flex items-start gap-3">
                      <Activity className="text-[#66021f] w-5 h-5 flex-shrink-0" />
                      <span>1 de cada 8 mujeres desarrolla cáncer de mama a lo largo de su vida.</span>
                    </p>
                  </div>
                  <div className="p-4 bg-[#F8E8EC] rounded-lg">
                    <p className="text-gray-800 flex items-start gap-3">
                      <AlertTriangle className="text-[#66021f] w-5 h-5 flex-shrink-0" />
                      <span>La detección temprana aumenta la supervivencia a más del 90%.</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md border border-[#E0C0C9]">
                <h3 className="text-xl font-semibold text-[#66021f] mb-3">Recomendaciones de prevención</h3>
                <ul className="space-y-3 text-gray-800">
                  <li className="flex gap-3 items-start p-3 hover:bg-[#F8E8EC] rounded-lg transition">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">A partir de los 40 años o antes si hay factores de riesgo</p>
                    </div>
                  </li>
                  <li className="flex gap-3 items-start p-3 hover:bg-[#F8E8EC] rounded-lg transition">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Realizar palpación mamaria 7-10 días después del período</p>
                    </div>
                  </li>
                  <li className="flex gap-3 items-start p-3 hover:bg-[#F8E8EC] rounded-lg transition">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Ante cualquier cambio, nódulo o secreción</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="flex flex-col lg:flex-row gap-12">
              <div className="w-full lg:w-1/2 space-y-8">
                <div className="bg-[#F8F1F3] p-8 rounded-xl shadow-sm border border-[#E0C0C9]">
                  ...
                  <p className="text-gray-700 mb-6">
                    El modelo de aprendizaje automático esta entrenado con miles de casos reales para identificar patrones predictivos de cáncer de mama.
                  </p>
                    ...
                    <div className="p-4 bg-white rounded-lg">
                      ...
                      <ul className="space-y-3 text-gray-700 pl-2">
                        <li className="flex items-start gap-2">
                          ...
                          <span>Analiza múltiples variables simultáneamente</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <div className="w-2 h-2 rounded-full bg-[#66021f] mt-2 flex-shrink-0"></div>
                ...
                <div className="bg-[#F8F1F3] p-8 rounded-xl shadow-sm border border-[#E0C0C9]">
                  <h3 className="text-2xl font-bold text-[#66021f] mb-4">Interpretación de resultados</h3>
                  <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 bg-white rounded-lg">
                      <div className="w-6 h-6 rounded-full bg-green-500 flex-shrink-0 mt-1"></div>
                      <div>
                        <h4 className="font-semibold text-gray-800">Bajo riesgo (0-20%)</h4>
                        <p className="text-sm text-gray-600">Continuar con controles rutinarios según protocolo.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 p-4 bg-white rounded-lg">
                      <div className="w-6 h-6 rounded-full bg-yellow-500 flex-shrink-0 mt-1"></div>
                      <div>
                        <h4 className="font-semibold text-gray-800">Riesgo moderado (20-50%)</h4>
                        <p className="text-sm text-gray-600">Considerar estudios adicionales y seguimiento cercano.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 p-4 bg-white rounded-lg">
                      <div className="w-6 h-6 rounded-full bg-red-500 flex-shrink-0 mt-1"></div>
                      <div>
                        <h4 className="font-semibold text-gray-800">Alto riesgo (50-100%)</h4>
                        <p className="text-sm text-gray-600">Evaluación médica inmediata y plan de acción personalizado.</p>
                      </div>
                    </div>
                  </div>
                  <p className="text-sm text-gray-500 mt-4 italic">
                    * Estos porcentajes representan probabilidades estimadas basadas en datos.
                  </p>
                </div>
              </div>
              ...
              <div  className="w-full lg:w-1/2">
                  ...
                  <form onSubmit={handleForm} className="space-y-6">
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-6 rounded-lg font-bold flex items-center justify-center ${
                        isLoading ? "bg-[#A53860]" : "bg-white text-[#66021f] hover:bg-[#F8E8EC]"
                ...
                <div className="mt-8 bg-[#F8F1F3] p-6 rounded-xl border border-[#E0C0C9]">
                  <h4 className="text-lg font-semibold text-[#66021f] mb-3">Variables analizadas</h4>
                  <p className="text-gray-700 mb-4">
                    Nuestro modelo considera 10 parámetros clínicos clave obtenidos de biopsias y estudios por imágenes:
                  </p>
        ...
        <section className="px-6 py-12 max-w-6xl mx-auto">
          <div className="bg-[#F8E8EC] p-8 rounded-xl text-center">
            <h3 className="text-2xl font-bold text-[#66021f] mb-4">Importante</h3>
            <p className="text-gray-800 mb-4">
              Esta herramienta está diseñada para <strong>apoyar</strong> a profesionales de la salud y <strong>no reemplaza</strong> el juicio clínico.
            </p>
            <p className="text-gray-800">
              Los resultados deben interpretarse en el contexto del cuadro clínico completo del paciente.
            </p>
          </div>
        </section>
      </main>
